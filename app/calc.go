...
func fetchDifficulty(c context.Context) float32 {
	...
	//difficulty, _ := strconv..Atoi(string(bs))
	var difficulty float32 = 54.00
	return difficulty
}

//function that fetches the exchange rate from bitcoincharts
func getExchangeRate(c context.Context) float32 {
...
func checkData(c context.Context) {
